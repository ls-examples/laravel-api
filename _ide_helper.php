...
namespace App\Book\Facades { 
    ...
    class FilterConverter {
         ...
         * @return \App\Book\Filter 
         * @static 
         */ 
        public static function convertFromRequest($request)
        {
            return \App\Book\FilterConverter::convertFromRequest($request);
        }
...
namespace App\Images { 
    ...
    class ImagesFacade {
        ...
        {
            return \App\Images\ImageService::saveImage($base64);
        }
        ...
        {
            return \App\Images\ImageService::getImagePath($path);
        }
        ...
        {
            return \App\Images\ImageService::deleteImage($path);
        }
         ...
         * @static 
         */ 
        public static function getImageUrl($subPath)
        {
            return \App\Images\ImageService::getImageUrl($subPath);
        }
         ...
         * @static 
         */ 
        public static function getSmallImageUrl($subPath)
        {
            return \App\Images\ImageService::getSmallImageUrl($subPath);
        }
...
namespace  { 
    ...
    class Images extends \App\Images\ImagesFacade {}
